...
export const workPermits = pgTable("work_permits", {
  ...
  accidentTypes: text("accident_types"),
  safetyMeasures: text("safety_measures"),
  riskComplexity: integer("risk_complexity"),
  riskScope: integer("risk_scope"),
  riskFrequency: integer("risk_frequency"),
  riskOverall: integer("risk_overall"),
  riskReason: text("risk_reason"),
  mitigationMeasures: text("mitigation_measures"),
  safetyChecks: text("safety_checks"),
  vocComment: text("voc_comment"),
